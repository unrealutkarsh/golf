...
None of these assets are from GS Pro, PGA Tour 2K, or other copyrighted golf titles.

## Textures

- **pine_tree_01** bark — [Poly Haven](https://polyhaven.com/a/pine_tree_01), CC0
- **Foliage001** canopy cards — [ambientCG](https://ambientcg.com/view?id=Foliage001), CC0

Turf, greens and bunkers use an original flat palette painted in code (`src/art.ts`); no turf photo textures ship.

...
import { LEAF_CARDS_PER_TREE, OAK_CANOPY_BLOBS, PINE_CANOPY_LAYERS, treeKind, volumeTreeMeshCount } from "./foliage";
...
describe("volume foliage", () => {
  it("uses layered canopy volumes instead of a four-card silhouette", () => {
    ...
    expect(LEAF_CARDS_PER_TREE).toBeGreaterThanOrEqual(4);
